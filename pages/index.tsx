...
const IndexPage = () => (
    <Layout title="MOROVENTO">
        <img
            src="/images/xera.svg"
            alt="Themeptation "
            className="absolute h-96 -top-20 -right-16 lg:right-5 lg:top-10 w-2/3	 md:w-auto  md:block animate-blob "
        />
        ...
        <div className="relative z-10 py-6 space-y-16 lg:space-y-32 text-gray-900 content">
            <div className="text-center space-y-10">
                ...
                <h1 className="text-5xl lg:text-9xl text-gray-800 font-extrabold">We’r blowing up</h1>
